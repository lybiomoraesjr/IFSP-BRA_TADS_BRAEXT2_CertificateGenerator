...
const funcaoCriaMain = () => {
  ...
  criaH1.innerHTML = "Gerador Certificado 2";
...
const funcaoCriaMenu = () => {
  ...
  criaA3.setAttribute("href", "./certificado2.html");
  ...
  criaA4.setAttribute("href", "./certificado3.html");
  ...
  criaA3Mobile.setAttribute("href", "./certificado2.html");
  ...
  criaA4Mobile.setAttribute("href", "./certificado3.html");
...
const funcaoCriaCertificadoAmostra = () => {
  ...
  if (inputMasculino.checked) {
    ...
    criaCertificadoAmostra.setAttribute(
      "src",
      "../images/certificado2_menino.png"
    );
    ...
    criaCertificadoAmostra.setAttribute(
      "src",
      "../images/certificado2_menina.png"
    );
